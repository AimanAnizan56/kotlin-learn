...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        lemonImage?.contentDescription = "$lemonadeState image"
        when(lemonadeState) {
            SELECT -> {
                textAction.text = getString(R.string.text_select)
                lemonImage?.setImageResource(R.drawable.lemon_tree)
            }

            SQUEEZE -> {
                textAction.text = getString(R.string.text_squeeze)
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
            }

            DRINK -> {
                textAction.text = getString(R.string.text_drink)
                lemonImage?.setImageResource(R.drawable.lemon_drink)
            }

            RESTART -> {
                textAction.text = getString(R.string.text_restart)
